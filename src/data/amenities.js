...
(()=>{
 ...
 const D={
  ...
  oilBrazier:{id:"oilBrazier",name:"Oil Brazier",category:"Military",icon:"🔥",footprint:[1,1],cost:{stone:45,ironOre:12,gold:150},buildTime:8,xpReward:50,requiredTownLevel:5,defenseTurret:true,range:2.8,damage:11,fireRate:.72,projectile:"fire"},
  ballistaPlatform:{id:"ballistaPlatform",name:"Compact Ballista",category:"Military",icon:"🏹",footprint:[1,1],cost:{wood:85,stone:50,ironBar:6,gold:260},buildTime:12,xpReward:80,requiredTownLevel:7,defenseTurret:true,range:6.2,damage:17,fireRate:.8,projectile:"bolt"},
