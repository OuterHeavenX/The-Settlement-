...
async function startWebGL(game,canvas){try{const{LegendsWorld3D}=await import("./LegendsWorld3D.js?v=0.16.0-stability1");const world=new LegendsWorld3D(game,canvas);return(await Promise.resolve(world.init()))?world:null}catch(e){console.error("The Settlement: permanent-day Legends 3D renderer failed; remaining safely in 2D",e);return null}}
