...
async function boot(){
 ...
 let GothicWorld3D;try{({GothicWorld3D}=await import("./GothicWorld3D.js"))}catch(e){console.error("Gothic 3D presentation unavailable, staying on the 2D renderer:",e);return}
 ...
 const world=new GothicWorld3D(game,c3d);let started=false;try{started=world.init()}catch(e){console.error("World3D init failed:",e);started=false}
 ...
 console.info("The Settlement: Gothic World Evolution 3D renderer active");
}
boot();
