...
async function boot(){
 ...
 let StableWorld3D;try{({StableWorld3D}=await import("./World3DStability.js"))}catch(e){console.error("3D stability layer unavailable, staying on the 2D renderer:",e);return}
 ...
 const world=new StableWorld3D(game,c3d);let started=false;try{started=world.init()}catch(e){console.error("World3D init failed:",e);started=false}
