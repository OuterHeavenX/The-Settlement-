...
Settlement.GothicWorldSystem=class{
 ...
 propKinds(b){let tier=this.tierNumber(b?.level||1),base={cottage:["firewood","barrel","garden","fence"],quarry:["stonePile","cart","timberSupport","rubble"],ironMine:["orePile","cart","timberSupport","lantern"],lumber:["logs","stump","sawhorse","timberRack"],warehouse:["crates","barrels","sacks","hoist"],mill:["sacks","grain","barrel","lantern"],bakery:["firewood","basket","barrel","lantern"],mason:["stonePile","cutStone","workbench","scaffold"],smelter:["orePile","cart","barMolds","lantern"],blacksmith:["ironBars","anvil","toolRack","lantern"],market:["crates","barrels","stalls","banner"],training:["dummy","weaponRack","target","banner"],barracks:["weaponRack","crates","banner","lantern"],farm:["basket","hay","scarecrow","tool"],archery:["banner","torch","crate","torch"],mainHall:["banner","lantern","statue","planter"]}[b?.type]||[];return base.slice(0,Math.min(base.length,Math.max(1,tier)))}
