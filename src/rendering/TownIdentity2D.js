/* THE SETTLEMENT — 2D Town Identity & Visual Clarity
 * Presentation-only overlay: Gothic building plaques, selection emphasis and
 * tiny operating-state marks. Reads simulation state, never mutates it.
 */
(()=>{
