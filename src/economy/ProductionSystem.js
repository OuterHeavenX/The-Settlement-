Settlement.ProductionSystem=class{
 ...
 storageCanFit(recipe){let r=this.game.resources;return Object.entries(recipe.output).every(([k,n])=>!r.isStoredResource(k)||r.remainingCapacity(k)+(Number(recipe.input?.[k])||0)>=n)}
